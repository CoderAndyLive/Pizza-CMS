...
<body>
        ...
        <table class="pizzas_seite_table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>{{ $pizza->Preis }}</td>
                    <td>{{ $pizza->Zutaten }}</td>
                    <td>{{ $pizza->Beschreibung }}</td>
                    <td>
                        <a class="button" href="{{ route('editPizza', ['id' => $pizza->id]) }}">
                            <i class="fas fa-edit"></i>
                        </a>
                    </td>
                    <td>
                        <a href="{{ route('pizza.confirmDelete', $pizza->id) }}" class="button">
    ...
    <script>
        ...
        // Function to toggle the Add Pizza Form visibility
